...
export default class BlockingConditionAlertMail extends BaseMail {
  subject: string
  ...
  constructor(opts: {
    ...
    const t = getTranslation('blockingConditionAlert', this.lang)
  ...
  private buildHtml(): string {
    ...
    const body = `
      ...
      <p><strong>${t.levelLabel}:</strong> ${t.levelValue}</p>
      ...
      <p class="text-muted">${t.urgentNotice}</p>
    `
