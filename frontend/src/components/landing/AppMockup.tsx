      ...
      <div className="rounded-t-2xl overflow-hidden border border-stone-200 border-b-0 shadow-[0_25px_80px_rgba(30,58,95,0.25),0_8px_30px_rgba(0,0,0,0.12)]">
        ...
        <div className="bg-stone-50 p-4 sm:p-6">
          <div className="max-w-3xl mx-auto">
            {/* Back link */}
            <p className="text-xs text-stone-400 mb-3">&larr; Transactions</p>
            ...
            <div className="flex flex-wrap items-center gap-2 mt-2 mb-4">
              ...
              <span className="text-xs text-emerald-600">(offre acceptée)</span>
            ...
            <div className="bg-primary/5 border border-primary/10 rounded-xl p-3 mb-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-[10px] text-stone-500">Fermeture prévue</p>
                  <p className="text-base font-bold text-primary">15 mars 2026</p>
                </div>
              ...
              <div className="mt-3 pt-3 border-t border-primary/5 flex items-center gap-3">
                <p className="text-[10px] text-stone-500">Étape 4 / 8</p>
                <div className="flex-1 h-1.5 bg-stone-200 rounded-full overflow-hidden">
                  <div className="h-full bg-primary rounded-full" style={{ width: '50%' }} />
                </div>
                <p className="text-[10px] text-stone-400">Période conditionnelle</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-stone-200 shadow-sm p-3 mb-4">
              ...
              <div className="flex flex-wrap gap-1.5">
                <span className="px-2 py-0.5 bg-stone-100 text-stone-600 rounded text-[10px]">Résidentiel</span>
                <span className="px-2 py-0.5 bg-stone-100 text-stone-600 rounded text-[10px]">Rural</span>
                <span className="px-2 py-0.5 bg-blue-50 text-blue-700 rounded text-[10px] font-medium">Financé</span>
                <span className="px-2 py-0.5 bg-stone-100 text-stone-600 rounded text-[10px]">Puits artésien</span>
                <span className="px-2 py-0.5 bg-stone-100 text-stone-600 rounded text-[10px]">Fosse septique</span>
              </div>
            </div>
            ...
            <div className="bg-amber-50/70 border border-amber-200 rounded-xl p-3 mb-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-stone-700 flex-1">Test eau potable — puits artésien</span>
                  <span className="text-[10px] text-red-600 font-medium">Échéance dans 3j</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-amber-500 shrink-0" />
                  <span className="text-xs text-stone-700 flex-1">Approbation de financement</span>
                  <span className="text-[10px] text-amber-600 font-medium">5 jours restants</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-stone-200 shadow-sm px-4 py-3 mb-5 flex items-center justify-between">
              <p className="text-xs text-stone-600 font-medium flex items-center gap-1.5">
                ...
                Documents <span className="text-stone-400">(6)</span>
              </p>
              <div className="flex items-center gap-3">
                <span className="flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full">
                  <span className="w-2 h-2 rounded-full bg-emerald-500" />
                  <strong className="text-emerald-700">3</strong>
                  <span className="text-stone-500 hidden sm:inline">Validées</span>
                </span>
                <span className="flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full">
                  <span className="w-2 h-2 rounded-full bg-amber-500" />
                  <strong className="text-amber-700">2</strong>
                  <span className="text-stone-500 hidden sm:inline">En attente</span>
                </span>
                <span className="flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full">
                  <span className="w-2 h-2 rounded-full bg-red-500" />
                  <strong className="text-red-700">1</strong>
                  <span className="text-stone-500 hidden sm:inline">Manquante</span>
                </span>
              </div>
            </div>
            ...
            <div className="space-y-0">
              ...
              <div className="flex gap-3">
                ...
                <div className="pb-4 flex-1">
                  <p className="text-xs font-semibold text-stone-700">1. Consultation <span className="text-stone-400 font-normal">&middot; 12 jan.</span></p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="pb-4 flex-1">
                  <p className="text-xs font-semibold text-stone-700">2. Offre soumise <span className="text-stone-400 font-normal">&middot; 20 jan.</span></p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="pb-4 flex-1">
                  <p className="text-xs font-semibold text-stone-700">3. Offre acceptée <span className="text-stone-400 font-normal">&middot; 25 jan.</span></p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="pb-4 flex-1">
                  <p className="text-sm font-bold text-primary mb-0.5">4. Période conditionnelle</p>
                  <p className="text-[10px] text-stone-400 mb-3">Depuis 17 jours</p>
                    ...
                    <div className="ml-4 space-y-2">
                      ...
                      <div className="bg-white rounded-lg border border-stone-200 p-2.5 flex items-start gap-2.5">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-medium text-stone-700">Inspection résidentielle</p>
                          <p className="text-[10px] text-stone-400 mt-0.5">Complétée le 5 fév. &middot; <span className="text-emerald-600">Preuve uploadée</span></p>
                        </div>
                        <span className="px-2 py-0.5 bg-emerald-50 text-emerald-700 rounded text-[9px] font-medium shrink-0">Validée &#10003;</span>
                      </div>
                      ...
                      <div className="bg-white rounded-lg border border-red-200 p-2.5 flex items-start gap-2.5">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5 mb-0.5">
                            <p className="text-xs font-medium text-stone-700">Test eau potable — puits artésien</p>
                            <span className="px-1.5 py-0.5 bg-amber-50 text-amber-700 border border-amber-200 rounded text-[8px] font-medium">IA</span>
                          </div>
                          <p className="text-[10px] text-stone-400">Générée auto &middot; Propriété rurale avec puits détectée</p>
                        </div>
                        <span className="px-2 py-0.5 bg-red-50 text-red-700 rounded text-[9px] font-medium shrink-0">3 jours</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="ml-4">
                      <div className="bg-white rounded-lg border border-amber-200 p-2.5 flex items-start gap-2.5">
                        <div className="w-4 h-4 rounded border-2 border-stone-300 mt-0.5 shrink-0" />
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-medium text-stone-700">Approbation de financement</p>
                          <p className="text-[10px] text-stone-400">En attente du prêteur &middot; Soumis le 1 fév.</p>
                        </div>
                        <span className="px-2 py-0.5 bg-amber-50 text-amber-700 rounded text-[9px] font-medium shrink-0">5 jours</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="ml-4">
                      <div className="bg-white rounded-lg border border-stone-200 p-2.5 flex items-start gap-2.5">
                        <div className="w-4 h-4 rounded border-2 border-emerald-500 bg-emerald-500 flex items-center justify-center text-white text-[8px] mt-0.5 shrink-0">&#10003;</div>
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-medium text-stone-700">Inspection fosse septique</p>
                          <p className="text-[10px] text-stone-400">Complétée le 6 fév. &middot; <span className="text-emerald-600">Rapport reçu</span></p>
                        </div>
                        <span className="px-2 py-0.5 bg-emerald-50 text-emerald-700 rounded text-[9px] font-medium shrink-0">Validée &#10003;</span>
                      </div>
                    </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="pb-4"><p className="text-xs text-stone-400">5. Ferme en attente</p></div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="pb-4"><p className="text-xs text-stone-400">6. Pré-closing</p></div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="pb-4"><p className="text-xs text-stone-400">7. Jour du closing</p></div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div><p className="text-xs text-stone-400">8. Post-closing</p></div>
              </div>
            </div>
          </div>
        </div>
