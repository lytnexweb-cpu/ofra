      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="lg:hidden fixed inset-0 top-16 bg-black/40 z-dialog"
            aria-hidden="true"
            onClick={onNavClick}
          />
          ...
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="lg:hidden relative z-sheet overflow-hidden overflow-y-auto max-h-[calc(100vh-4rem)]"
          >
