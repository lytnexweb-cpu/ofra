...
|-----------|----------|-----|--------|
| **Frontend** | Cloudflare Pages | https://ofra.pages.dev | ✅ Live |
| **Backend** | Fly.io | https://crm-yanick-backend.fly.dev | ✅ Live |
| **Database** | Fly.io (Postgres) | Internal | ✅ Running |

### GitHub Repository

- **Repo**: [github.com/lytnexweb-cpu/ofra](https://github.com/lytnexweb-cpu/ofra)
- **Branch**: `main`
...
| **Environment variable** | `VITE_API_URL` = `https://crm-yanick-backend.fly.dev` |
